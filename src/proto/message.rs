...
use super::{code, request::Request, response::Response, ProtoError};
...
impl Request for RequestIdentities {
    type ResponseType = IdentitiesAnswer;

    const REQUEST_CODE: code::RequestCode = code::RequestCode::RequestIdentities;
}
